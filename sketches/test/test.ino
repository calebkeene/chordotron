...
void loop() {
  ...
  // play from C3# (49) to A# (58) (ascending and descending)
  // measure new position of fret 1
//  if (testFret) {
//    for (int i = 1; i < 10; i++) {
//      noteOnHandler(0, startPitch + i, 50);
//      delay(250);
//      noteOffHandler(0, startPitch + 1, 50);
//      delay(250);
//    }
//
//    for (int i = 8; i > -1; i--) {
